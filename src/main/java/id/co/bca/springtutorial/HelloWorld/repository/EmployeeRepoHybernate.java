...
@Repository
public class EmployeeRepoHybernate  implements IEmployeeRepository{
    ...
    public List<EmployeeModel> retrieveAll() {
        return entityManager.createQuery("select a from EmployeeModel a", EmployeeModel.class).getResultList();
    }
